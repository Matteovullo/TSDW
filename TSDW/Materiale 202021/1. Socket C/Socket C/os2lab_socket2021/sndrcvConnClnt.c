...
/* client come il connectionless sndrcvClessclnt.c, cioè con datagram/UDP;
 * solo, usa connect() con send() and recv(), anziché sendto()/recvfrom();
 * la comunicazione resta connectionless a tutti gli effetti, si ottiene
 * un'abbreviazione dei parametri, perche', grazie a connect(),
 * l'indirizzo con cui si comunica e` implicito
 */
